...
- [ ] **A41.** Convert large rebuild services into V4 chunk-manifest/backfill
      ...
      re-staging `project_mart_large_rebuild_state`. A41 remains partial because
      the internal large-rebuild
