...
- [ ] **A40.** Retire dirty materialization and mart refresh as legacy serving
      ...
      and the old worker tests, and current dirty-materialization cleanup deletes
      `projectMartDirtyMaterializationService.ts` plus its service test. A40
      remains partial because
