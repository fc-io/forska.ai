...
- [~] **A10.** Add runtime-role assertions proving API role cannot acquire
  ...
  read-only wrappers; `getAppQueryService.ts` remains covered structurally by
  route proxying/residual classification rather than a dedicated API-role wrapper
  test.
