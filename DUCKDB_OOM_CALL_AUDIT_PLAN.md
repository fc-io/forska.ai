...
- [~] **A21.** Migrate comparison project reads to complete bounded serving
  ...
  export, and conflict-resolution export.
...
- [~] **A30.** Extend admission/diagnostic evidence for unchecked detail,
      ...
      contract coverage. Remaining blockers: source validation/matching routes
      for comparison conflict-resolution import still need a serving-owned match
      key contract before the comparison row can be fully migrated.
