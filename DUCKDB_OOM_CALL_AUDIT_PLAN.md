...
- [ ] **A40.** Retire dirty materialization and mart refresh as legacy serving
      ...
      deleted. A40 remains partial only for the dirty-refresh ledger/quarantine
      state that can disappear after the remaining large-rebuild services are
      retired under A41.
