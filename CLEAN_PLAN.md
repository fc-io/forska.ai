...
## 3. Other root docs likely legacy/duplicate (0 refs)
- Unexpected-answers docs: merge into 1 doc under `docs/`, then delete extras:
  ...
  - `INVESTIGATE_UNEXPECTED_ANSWERS.md` (keep OR delete after merge)
- Parquet-era docs (if Parquet is fully gone): archive/delete
  - `CLICK_VERIFICATION.md`
  - `REMOVE_PARQUET.md`
- Misc (verify first): move to `docs/` or delete if stale
  - `MN5_CONNECTIVITY_OPTIONS.md`
  - `DOCLING_SERVE_ALVIS2.md`
