...
Decision: "Chinese" means article language/script, not author country or institution country.
...
| 5 | UI | Add a compact Chinese vs Non-Chinese section on the compare projects stats card, shown only when the project has Chinese articles. |
...
- [ ] Hide the Chinese vs Non-Chinese stats section when the Chinese article count is 0.
