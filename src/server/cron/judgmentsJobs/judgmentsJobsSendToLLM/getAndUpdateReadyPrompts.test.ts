        ...
        void mock.module(judgeWorkerCompletionJournalModulePath, () => {
          return {
            ...
            getOwnerBackedJudgmentJobInfo: async () => ({
              ...
              providerConfigJson: {},
              providerId: 'connection-codex',
              providerKey: 'connection-codex',
              providerLimit: 20,
              providerLimitVersion: 'version-codex',
              providerName: 'Codex',
              providerUsesFamilyDefault: false,
        ...
        void mock.module(judgeWorkerCompletionJournalModulePath, () => {
          return {
            ...
            getOwnerBackedJudgmentJobInfo: async () => ({
              ...
              providerId: 'connection-sglang',
              providerKey: 'connection-sglang',
              providerLimit: 8,
              providerLimitVersion: 'version-sglang',
              providerName: 'SGLang',
              providerUsesFamilyDefault: false,
