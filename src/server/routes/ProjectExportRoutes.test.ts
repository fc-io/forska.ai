...
test('project export serving queries read prompt and judgment scalars', () => {
  ...
  expect(judgmentExportQuery).toContain('judgment.explanation AS explanation')
  expect(judgmentExportQuery).toContain('judgment.quotes AS quotes')
  expect(judgmentExportQuery).toContain('LEFT JOIN app."judgment" judgment')
  expect(judgmentExportQuery).toContain('judgment.id = detail.judgment_id')
