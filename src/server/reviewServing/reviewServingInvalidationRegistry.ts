...
export const reviewServingInvalidationRegistry: Record<ReviewServingChangeKind, ReviewServingInvalidationRule> = {
  ...
  'judgment.human.updated': rule({
    affectedComponents: ['humanStatus', 'queue', 'payload', 'posting', 'summary'],
    changeKind: 'judgment.human.updated',
    downstreamDependents: ['queue', 'payload', 'posting', 'summary'],
  ...
  'judgment.llm.created': rule({
    affectedComponents: ['llmStatus', 'queue', 'payload', 'posting', 'summary'],
  ...
  'prompt.config.updated': rule({
    affectedComponents: ['llmStatus', 'humanStatus', 'queue', 'posting', 'summary', 'payload'],
    changeKind: 'prompt.config.updated',
    downstreamDependents: ['queue', 'posting', 'summary', 'payload'],
    firstAffectedComponent: 'llmStatus',
