  ...
  return {
    ...
    workload: {
      ...
      operations: [
        ...
        {...reviewServingBenchmarkOverlapWorkloadDefinition.operations[16], requestCount: 1},
        {...reviewServingBenchmarkOverlapWorkloadDefinition.operations[17], requestCount: 1},
        {...reviewServingBenchmarkOverlapWorkloadDefinition.operations[18], requestCount: 1},
        {...reviewServingBenchmarkOverlapWorkloadDefinition.operations[19], requestCount: 1},
        {
    ...
    workItems: [
      ...
      },
      {
        admissionRequest: {
          contractKey: 'review.human.list.judgments',
          estimatedResultBytes: 3_000,
          estimatedResultRows: 3,
          pageSize: 3,
          projectId: 'smoke-project',
          snapshotFreshness: 'ready',
          snapshotId: 'smoke-snapshot',
