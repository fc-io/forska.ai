  ...
  return {
    ...
    workload: {
      ...
      operations: [
        ...
        {...reviewServingBenchmarkOverlapWorkloadDefinition.operations[20], requestCount: 1},
        {...reviewServingBenchmarkOverlapWorkloadDefinition.operations[21], requestCount: 1},
        {
