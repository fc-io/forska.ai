  ...
  return {
    ...
    workload: {
      ...
      operations: [
        ...
        {...reviewServingBenchmarkOverlapWorkloadDefinition.operations[13], requestCount: 1},
        {...reviewServingBenchmarkOverlapWorkloadDefinition.operations[14], requestCount: 1},
        {...reviewServingBenchmarkOverlapWorkloadDefinition.operations[15], requestCount: 1},
        {
