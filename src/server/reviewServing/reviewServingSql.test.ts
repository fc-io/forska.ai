...
test('buildReviewServingRowsSql covers judgment detail rows for article details', () => {
  ...
  expect(sql).toContain('mart.review_article_judgment_detail_serving_v4.judgment_updated_at')
  expect(sql).toContain('mart.review_article_judgment_detail_serving_v4.confidence_original')
  expect(sql).toContain('mart.review_article_judgment_detail_serving_v4.model_name')
  expect(sql).toContain('mart.review_article_judgment_detail_serving_v4.assessment_id')
  expect(sql).toContain('mart.review_article_judgment_detail_serving_v4.assessment_updated_at')
...
test('buildReviewServingRowsSql pins fixed list-mode judgment payload reads', () => {
  ...
  expect(humanListSql).toContain('mart.review_article_judgment_detail_serving_v4.judgment_updated_at')
  expect(humanListSql).toContain('mart.review_article_judgment_detail_serving_v4.model_provider')
...
test('buildReviewServingRowsSql supports article-set list judgment lookups', () => {
  ...
  expect(sql).toContain('mart.review_article_judgment_detail_serving_v4.explanation')
  expect(sql).toContain('mart.review_article_judgment_detail_serving_v4.quotes')
  expect(sql).toContain('mart.review_article_judgment_detail_serving_v4.snapshot_project_model_name')
