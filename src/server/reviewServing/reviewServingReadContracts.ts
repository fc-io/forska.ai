...
const reviewQueueServingTable = 'mart.review_unassessed_queue_article_rank_serving_v4'
...
export const reviewServingReadContractList = [
  ...
  rowByArticleSetContract({
    allowedFilters: [...defaultRowFilters, 'articleId', 'conflictFlag', 'queueKind'],
    cursorFields: unassessedRowCursorFields,
  ...
  defineContract({
    allowedFilters: [...defaultCountFilters, 'queueKind', 'searchTokenPrefix'],
    cursorFields: [],
    freshnessBehavior: 'requireReadySnapshot',
  ...
  defineContract({
    ...
    optionalComponents: [],
    physicalAccessStrategy: 'articleSetLookup',
    requiredComponents: ['llmStatus', 'payload'],
    searchMode: 'none',
    servingTable: reviewJudgmentDetailServingTable,
  ...
  defineContract({
    ...
    optionalComponents: [],
    physicalAccessStrategy: 'articleSetLookup',
    requiredComponents: ['humanStatus', 'payload'],
    searchMode: 'none',
    servingTable: reviewJudgmentDetailServingTable,
    sort: {direction: 'asc', fields: ['article_id', 'prompt_order ASC NULLS LAST', 'prompt_id']},
    workloadClass: 'foregroundReviewRows',
  ...
  defineContract({
    ...
    optionalComponents: [],
    physicalAccessStrategy: 'articleSetLookup',
    requiredComponents: ['llmStatus', 'humanStatus', 'payload'],
    searchMode: 'none',
    servingTable: reviewJudgmentDetailServingTable,
    sort: {direction: 'asc', fields: ['article_id', 'prompt_order ASC NULLS LAST', 'prompt_id']},
    workloadClass: 'foregroundReviewRows',
...
export const reviewServingReadContractRouteInventory = [
  ...
  {
    contractKeys: ['review.warning.snapshot'],
    method: 'POST',
    mounted: true,
