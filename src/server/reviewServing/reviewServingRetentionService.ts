...
export type ReviewServingRetentionCleanupSpecKind = 'snapshot' | 'terminalRebuildChunkManifest'
...
const cleanupTableSpecs: readonly CleanupTableSpec[] = [
  {keyColumn: 'snapshot_id', protectedPredicate: 'snapshot_id', table: 'mart.review_article_serving_base_v4'},
  {
  ...
  {keyColumn: 'snapshot_id', protectedPredicate: 'snapshot_id', table: 'mart.review_filtered_count_serving_v4'},
