DROP INDEX IF EXISTS idx_app_provider_admission_lease_expiry;

DROP TABLE IF EXISTS app.provider_admission_lease;

CREATE TABLE app.provider_admission_lease (
