CREATE TEMP TABLE provider_model_model_backup AS
SELECT * FROM app.model;

CREATE TEMP TABLE provider_model_project_backup AS
SELECT * FROM app.project;

CREATE TEMP TABLE provider_model_project_prompt_backup AS
SELECT * FROM app.project_prompt;

CREATE TEMP TABLE provider_model_project_import_route_backup AS
SELECT * FROM app.project_import_route;

CREATE TEMP TABLE provider_model_project_article_backup AS
SELECT * FROM app.project_article;

CREATE TEMP TABLE provider_model_judgment_job_backup AS
SELECT * FROM app.judgment_job;

CREATE TEMP TABLE provider_model_judgment_job_prompt_backup AS
SELECT * FROM app.judgment_job_prompt;

CREATE TEMP TABLE provider_model_judgment_backup AS
SELECT * FROM app.judgment;

CREATE TEMP TABLE provider_model_judgment_human_backup AS
SELECT * FROM app.judgment_human;

CREATE TEMP TABLE provider_model_review_backup AS
SELECT * FROM app.review;

CREATE TEMP TABLE provider_model_token_use_backup AS
SELECT * FROM app.token_use;

CREATE TEMP TABLE provider_model_judgment_assessment_backup AS
...
SELECT
  ...
  created_at,
  updated_at
FROM provider_model_model_backup;

INSERT INTO app.project SELECT * FROM provider_model_project_backup;
INSERT INTO app.project_prompt SELECT * FROM provider_model_project_prompt_backup;
INSERT INTO app.project_import_route SELECT * FROM provider_model_project_import_route_backup;
INSERT INTO app.project_article SELECT * FROM provider_model_project_article_backup;
INSERT INTO app.judgment_job SELECT * FROM provider_model_judgment_job_backup;
INSERT INTO app.judgment_job_prompt SELECT * FROM provider_model_judgment_job_prompt_backup;
INSERT INTO app.judgment SELECT * FROM provider_model_judgment_backup;
INSERT INTO app.judgment_human SELECT * FROM provider_model_judgment_human_backup;
INSERT INTO app.review SELECT * FROM provider_model_review_backup;
INSERT INTO app.token_use SELECT * FROM provider_model_token_use_backup;
INSERT INTO app.judgment_assessment SELECT * FROM provider_model_judgment_assessment_backup;
