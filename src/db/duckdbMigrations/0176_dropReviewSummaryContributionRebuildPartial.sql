DROP INDEX IF EXISTS mart.idx_review_article_summary_contribution_rebuild_partial_v4_unique;
DROP INDEX IF EXISTS idx_review_article_summary_contribution_rebuild_partial_v4_unique;
DROP INDEX IF EXISTS mart.idx_review_article_summary_contribution_rebuild_partial_v4_publish;
DROP INDEX IF EXISTS idx_review_article_summary_contribution_rebuild_partial_v4_publish;
...
SELECT *
FROM app.review_rebuild_partial_cleanup_authorization
WHERE partial_table = 'mart.review_article_summary_rebuild_partial_v4';
