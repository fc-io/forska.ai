DROP TABLE IF EXISTS mart.review_unassessed_queue_serving_v4_without_queue_identity;
...
INSERT INTO mart.review_unassessed_queue_serving_v4_without_queue_identity (
  project_id,
  review_config_hash,
  snapshot_id,
  queue_kind,
...
ALTER TABLE mart.review_unassessed_queue_serving_v4_without_queue_identity
