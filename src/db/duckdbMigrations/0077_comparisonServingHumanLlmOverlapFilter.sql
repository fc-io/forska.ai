...
ADD COLUMN IF NOT EXISTS has_human_vs_llm_overlap BOOLEAN DEFAULT FALSE;

ALTER TABLE mart.comparison_article_serving
ADD COLUMN IF NOT EXISTS passes_difference_filter_human_vs_llm_overlap BOOLEAN DEFAULT TRUE;
