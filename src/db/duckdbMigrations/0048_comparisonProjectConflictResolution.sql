CREATE TEMP TABLE comparison_project_conflict_resolution_project_backup AS
SELECT * FROM app.comparison_project;

CREATE TEMP TABLE comparison_project_conflict_resolution_prompt_backup AS
SELECT * FROM app.comparison_project_prompt;

CREATE TEMP TABLE comparison_project_conflict_resolution_import_route_backup AS
SELECT * FROM app.comparison_project_import_route;

CREATE TEMP TABLE comparison_project_conflict_resolution_source_project_backup AS
...
SELECT
  ...
  created_at,
  updated_at
FROM comparison_project_conflict_resolution_project_backup;
...
SELECT
  ...
  created_at,
  updated_at
FROM comparison_project_conflict_resolution_prompt_backup;
...
SELECT
  ...
  created_at,
  updated_at
FROM comparison_project_conflict_resolution_import_route_backup;
...
SELECT
  ...
  created_at,
  updated_at
FROM comparison_project_conflict_resolution_source_project_backup;

CREATE TABLE IF NOT EXISTS app.comparison_project_conflict_resolution (
  id VARCHAR PRIMARY KEY,
  comparison_project_id VARCHAR NOT NULL REFERENCES app.comparison_project(id),
