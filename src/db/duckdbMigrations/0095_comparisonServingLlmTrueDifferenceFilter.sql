...
ADD COLUMN IF NOT EXISTS has_llm_vs_llm_true_difference BOOLEAN DEFAULT FALSE;

ALTER TABLE mart.comparison_article_serving
ADD COLUMN IF NOT EXISTS passes_difference_filter_llm_vs_llm_true_difference BOOLEAN DEFAULT TRUE;
