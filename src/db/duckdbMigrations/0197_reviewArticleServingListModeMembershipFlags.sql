...
SET llm_has_judgment = FALSE
WHERE llm_has_judgment IS NULL;
...
SELECT
  ...
  article_id,
  list_mode_keys,
  list_contains(list_mode_keys, 'llm') AS has_llm_list_mode,
  list_contains(list_mode_keys, 'human') AS has_human_list_mode,
  list_contains(list_mode_keys, 'both') AS has_both_list_mode,
  list_contains(list_mode_keys, 'unassessed') AS has_unassessed_list_mode,
  llm_patch_watermark,
