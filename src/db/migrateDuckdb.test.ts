...
test('DuckDB migrations add project transfer session and history invariants', async () => {
  ...
  try {
    ...
    expect(indexNames).not.toContain('idx_app_project_transfer_session_stale_recovery')
    expect(indexNames).not.toContain('idx_app_project_transfer_session_owner_heartbeat')
    expect(indexNames).not.toContain('idx_app_project_transfer_session_commit')
    expect(indexNames).not.toContain('idx_app_project_transfer_session_package')
