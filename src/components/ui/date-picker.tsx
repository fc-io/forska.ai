...
const DatePickerTrigger = (props: DatePickerPrimitive.TriggerProps) => {
  ...
  const hasChildren = () => {
    return resolvedChildren.toArray().length !== 0
  }
  ...
  return (
    <DatePickerPrimitive.TableCellTrigger
      class={cn(
        ...
        // pointer when selectable, default when disabled; treat outside-of-month as selectable
        'cursor-pointer data-[disabled]:cursor-default',
        'data-[today]:bg-secondary data-[today]:text-secondary-foreground',
