                    ...
                    return (
                      <div class="flex flex-col gap-2">
                        ...
                        <Select.Root
                          ...
                          itemComponent={(props) => {
                            return (
                              <Select.Item item={props.item} class="relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-2 pr-8 text-sm outline-none data-[disabled]:pointer-events-none data-[highlighted]:bg-muted data-[disabled]:opacity-50">
