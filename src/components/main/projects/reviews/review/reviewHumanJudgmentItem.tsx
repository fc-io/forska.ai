  ...
  return (
    <div class="border-b last:border-b-0 p-3">
      <div class="flex justify-between items-start mb-2">
        <p class="text-sm font-medium text-gray-900 line-clamp-2 flex-1">{props.judgment.prompt.originalText}</p>
        <span class="text-xs text-gray-400 ml-2 font-mono" title={props.judgment.id}>
          #{props.judgment.id.slice(-8)}
        </span>
      </div>
      <div class="text-xs">
