...
const AdminImportRouteStatsArticleDetailsFulltext = () => {
...
export const Route = createFileRoute('/admin/import-route-stats/$year/$id/fulltext')({
  component: AdminImportRouteStatsArticleDetailsFulltext,
})
